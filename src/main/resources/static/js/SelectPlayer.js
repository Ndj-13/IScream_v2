class SelectPlayer {
    ...
    preload(){
        console.log('preload');
        this.scene.load.image("selectScreenBg", "assets/img/interface/pantallaSeleccion.png");
        this.scene.load.image('markbox', "assets/img/interface/recuadroBoton.png"); //REPE
        this.scene.load.image("chMarkbox", "assets/img/interface/eleccionPersonaje.png");
        this.scene.load.image("arrow", "assets/img/interface/flechita.png");
        //Aceptar
        this.scene.load.spritesheet('ok',
            'assets/img/interface/botonOk.png',
        ...
        for(var i = 1; i <= this.options; i++)
        {
            ...
            'assets/img/players/SpritesheetP'+i+'(Andar).png',
