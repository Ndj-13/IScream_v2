class Pause{
    ...
    preload() {
        this.scene.load.image("fondo1", "assets/img/interface/pauseFondo_chico.png");
        this.scene.load.image("titulo", "assets/img/interface/PAUSE.png");

        //Botones
        this.scene.load.image("marco", "assets/img/interface/recuadroBoton.png");
        this.scene.load.spritesheet('back', 
            'assets/img/interface/closeButton.png',
        ...
        //Pestaña aviso
        this.scene.load.spritesheet('yes', 'assets/img/interface/confirmButton.png', { frameWidth: 120, frameHeight: 47 });
        this.scene.load.spritesheet('no', 'assets/img/interface/cancelButton.png', { frameWidth: 120, frameHeight: 47 });
