class GameLoader extends Phaser.Scene {
    ...
    preload(){
        ...
        this.load.image('gameBg', 'assets/img/scene/fondoNivel1.png');
        ...
        this.load.image('loading', 'assets/img/interface/charactIcon1.png');
        ...
        for(var i = 0; i < playersList.length; i++)
        {
            ...
            'assets/img/players/SpritesheetP'+playersList[i].getCharactId()+'(Andar).png',
            { frameWidth: 64, frameHeight: 64 });
            //Damage
            this.load.spritesheet('damageP'+playersList[i].getCharactId(),
            'assets/img/players/DamageP'+playersList[i].getCharactId()+'.png',
            { frameWidth: 64, frameHeight: 64 });

            //Character interface
            this.load.image('charactIcon'+playersList[i].getCharactId(), 'assets/img/interface/charactIcon'+playersList[i].getCharactId()+'.png');
            this.load.image('score'+i, 'assets/img/interface/InterfazPuntuacionVacio.png');
        }
    }
