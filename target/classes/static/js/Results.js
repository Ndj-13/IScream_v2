class Results extends Phaser.Scene {
    ...
    preload() {
        //Background:
        this.load.image("stop", "assets/img/scene/fondoNivel1.png");
        this.load.image("fondo", "assets/img/interface/pauseFondo1.png");
        this.load.image("fondo2", "assets/img/interface/pauseFondo2.png");

        this.load.image("tituloRes", "assets/img/interface/RESULTS.png");

        //Botones
        this.load.image("marco", "assets/img/interface/recuadroBoton.png");
        ...
        this.load.spritesheet('retry',
            'assets/img/interface/botonRepeat.png',
            { frameWidth: 120, frameHeight: 47 });


        //Iconos:
        this.load.image('iconoJ1', 'assets/img/players/purpleIceHead.png');
        this.load.image('iconoJ2', 'assets/img/players/blueIceHead.png');
        this.load.image('crown', 'assets/img/interface/corona.png');

        //Variables
        //Puntuacion:

        //Pestaña aviso
        this.load.image('aviso', 'assets/img/interface/Warning.png');

        this.load.spritesheet('yes', 'assets/img/interface/confirmButton.png', { frameWidth: 120, frameHeight: 47 });
        this.load.spritesheet('no', 'assets/img/interface/cancelButton.png', { frameWidth: 120, frameHeight: 47 });
